...
@section('metaDescription', 'BLOSSOM\'s press kit — our story, brand assets, facts, and media contact information.')
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-12 stagger-children">
            ...
            @foreach($facts as $fact)
                <div class="bg-white rounded-2xl p-6 border border-silver text-center hover:shadow-lg hover:shadow-onion/5 transition-all duration-500">
                    <div class="font-display text-4xl font-bold text-onion mb-2">{{ $fact['value'] }}</div>
                    <div class="font-ui text-xs text-muted uppercase tracking-wider">{{ $fact['label'] }}</div>
                </div>
            @endforeach
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 stagger-children">
            <div class="bg-white rounded-2xl p-8 border border-silver flex items-center gap-6 hover:shadow-lg transition-all duration-500">
                <div class="w-20 h-20 rounded-xl bg-ink flex items-center justify-center flex-shrink-0">
                    <img src="{{ asset('assets/blossom-logo.png') }}" alt="BLOSSOM logo on dark" class="h-12 w-auto object-contain">
                </div>
                <div>
                    ...
                    <a href="{{ asset('assets/blossom-logo.png') }}" download class="font-ui text-sm text-onion font-semibold hover:text-orange transition-colors">Download →</a>
                </div>
            </div>
            <div class="bg-white rounded-2xl p-8 border border-silver flex items-center gap-6 hover:shadow-lg transition-all duration-500">
                <div class="w-20 h-20 rounded-xl bg-white border border-silver flex items-center justify-center flex-shrink-0">
                    <img src="{{ asset('assets/blossom-logo.png') }}" alt="BLOSSOM logo on light" class="h-12 w-auto object-contain">
                </div>
                <div>
    ...
    <div class="container-blossom">
        <div class="newsletter-cta p-10 lg:p-16 text-center reveal">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a href="{{ route('contact') }}" class="btn-ghost">Use Contact Form</a>
            </div>
        </div>
    </div>
</section>
