...
@section('metaDescription', 'The terms of service governing your use of the BLOSSOM magazine website and services.')
    ...
    <div class="container-blossom max-w-3xl">
        <div class="font-body text-lg text-primary leading-[1.8] space-y-8">
            ...
            <div>
                ...
                <p>Questions about these terms can be directed to our team via the <a href="{{ route('contact') }}" class="text-onion font-semibold hover:text-orange transition-colors">contact page</a>.</p>
            </div>
        </div>
    </div>
</section>
