...
@section('metaDescription', 'How BLOSSOM collects, uses, and protects your personal information.')
    ...
    <div class="container-blossom max-w-3xl">
        <div class="font-body text-lg text-primary leading-[1.8] space-y-8">
            ...
            <div>
                ...
                <p>For any privacy questions, reach our team via the <a href="{{ route('contact') }}" class="text-onion font-semibold hover:text-orange transition-colors">contact page</a>.</p>
            </div>
        </div>
    </div>
</section>
