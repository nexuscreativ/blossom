...
@section('metaDescription', 'Reach Nigeria's most engaged audience. Discover BLOSSOM's advertising opportunities, audience, formats, and rates.')
...
<section class="relative pt-32 pb-20 bg-ink overflow-hidden">
    ...
    <div class="container-blossom relative z-10 text-center">
        ...
        <h1 class="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
            Put Your Brand at the <span class="text-gradient-orange">Heart of Nigeria</span>
        </h1>
        <p class="font-body text-lg text-white/50 max-w-2xl mx-auto">
            BLOSSOM connects premium brands with Nigeria's most engaged, discerning audience — from Jos to the diaspora.
        </p>
    </div>
</section>
            ...
            <div class="reveal">
                ...
                <div class="space-y-4 font-body text-secondary leading-relaxed">
                    <p>
                        ...
                        in Nigeria — its business, heritage, and future. They are decision-makers with real influence
                        and spending power.
                    </p>
                    <p>
                        By advertising with BLOSSOM, your brand is seen as part of the conversation that defines the nation.
                    </p>
                </div>
            </div>
                ...
                <div class="grid grid-cols-2 gap-6 stagger-children">
                    @php
                        $stats = [
                            ...
                            ['value' => '1', 'label' => 'Devoted Nigerian audience'],
