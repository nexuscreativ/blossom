...
<?php $__env->startSection('metaDescription', 'Learn about BLOSSOM — Plateau\'s Prestige Magazine. Our mission, values, and the team behind the stories.'); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-2xl p-8 border border-silver hover:shadow-lg hover:shadow-onion/5 transition-all duration-500 text-center">
                    <div class="w-14 h-14 mx-auto rounded-xl bg-onion/5 border border-onion/10 flex items-center justify-center mb-5">
                        <svg class="w-6 h-6 text-onion" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><?php echo $value['icon']; ?></svg>
                    </div>
                    <h3 class="font-display text-xl font-bold text-ink mb-3"><?php echo e($value['title']); ?></h3>
                    <p class="font-body text-sm text-secondary leading-relaxed"><?php echo e($value['desc']); ?></p>
                </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $team; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="text-center group">
                    <div class="relative rounded-xl overflow-hidden aspect-square mb-4">
                        <img src="<?php echo e($member['img']); ?>" alt="<?php echo e($member['name']); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    </div>
                    <h4 class="font-display text-base font-bold text-ink"><?php echo e($member['name']); ?></h4>
                    <span class="font-ui text-xs text-muted"><?php echo e($member['role']); ?></span>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\WebWorka\codeworkflow\blossom\resources\views/pages/about/index.blade.php ENDPATH**/ ?>