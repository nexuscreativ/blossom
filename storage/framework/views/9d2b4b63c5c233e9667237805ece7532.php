...
<head>
    ...
    <title>Installation Complete &middot; <?php echo e(config('app.name', 'Blossom')); ?></title>
    <style>
        :root {
            --ink: #1c1917;
            --onion: #14532d;
...
<body>
    <div class="card">
        ...
        <a class="btn" href="<?php echo e(route('home')); ?>">Visit Site</a>
        <a class="btn btn-secondary" href="/admin">Open Admin</a>
    </div>
</body>
</html><?php /**PATH C:\WebWorka\codeworkflow\blossom\resources\views/install/complete.blade.php ENDPATH**/ ?>