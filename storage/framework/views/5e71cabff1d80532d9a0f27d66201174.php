<?php $__env->startSection('title', 'Featured Listings'); ?>
<?php $__env->startSection('metaDescription', 'Explore top businesses, services, and venues on the Plateau.'); ?>
    ...
    <div class="container-blossom">
        <div class="flex flex-col md:flex-row items-center gap-4">
            ...
            <div class="flex gap-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['Business', 'Personality', 'Institution']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('listings.show', $listing['slug'])); ?>" class="listing-card <?php echo e($listing['featured'] ? 'listing-card--featured' : ''); ?> group">
                    ...
                    <div class="p-5">
                        ...
                        <h3 class="font-display text-lg font-bold text-ink mt-2 group-hover:text-orange transition-colors"><?php echo e($listing['name']); ?></h3>
                        <p class="font-body text-sm text-muted mt-1 line-clamp-2"><?php echo e($listing['desc']); ?></p>
                    </div>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
...
<section class="py-16 bg-ink text-center">
    <div class="container-blossom">
        ...
        <a href="<?php echo e(route('contact')); ?>" class="btn-primary">Submit Your Listing</a>
    </div>
</section>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\WebWorka\codeworkflow\blossom\resources\views/pages/listings/index.blade.php ENDPATH**/ ?>