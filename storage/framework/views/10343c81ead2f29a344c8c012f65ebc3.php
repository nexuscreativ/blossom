<?php $__env->startSection('title', 'Advertise with BLOSSOM'); ?>
<?php $__env->startSection('metaDescription', 'Reach Plateau\'s most engaged audience. Discover BLOSSOM\'s advertising opportunities, audience, formats, and rates.'); ?>
                ...
                <div class="grid grid-cols-2 gap-6 stagger-children">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-2xl p-6 border border-silver text-center hover:shadow-lg hover:shadow-orange/5 transition-all duration-500">
                            <div class="font-display text-4xl font-bold text-orange mb-2"><?php echo e($stat['value']); ?></div>
                            <div class="font-ui text-xs text-secondary uppercase tracking-wider"><?php echo e($stat['label']); ?></div>
                        </div>
...
<section class="py-16 bg-pearl">
    <div class="container-blossom">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 stagger-children">
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $formats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $format): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-2xl p-8 border border-silver hover:shadow-lg hover:shadow-orange/5 transition-all duration-500">
                    <div class="w-14 h-14 mx-auto rounded-xl bg-orange/5 border border-orange/10 flex items-center justify-center mb-5">
                        <svg class="w-6 h-6 text-orange" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><?php echo $format['icon']; ?></svg>
                    </div>
                    <h3 class="font-display text-xl font-bold text-ink mb-3 text-center"><?php echo e($format['title']); ?></h3>
                    <p class="font-body text-sm text-secondary leading-relaxed text-center"><?php echo e($format['desc']); ?></p>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
...
<section class="py-16 lg:py-24">
    <div class="container-blossom">
        <div class="newsletter-cta p-10 lg:p-16 text-center reveal">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="btn-primary">Request a Media Kit</a>
        </div>
    </div>
</section>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\WebWorka\codeworkflow\blossom\resources\views/pages/advertise/index.blade.php ENDPATH**/ ?>