...
<?php $__env->startSection('metaDescription', 'Get in touch with BLOSSOM Magazine. We love hearing from our readers, partners, and the Plateau community.'); ?>
    ...
    <div class="container-blossom">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div class="reveal">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('contact_error')): ?>
                    <div class="mb-6 p-4 rounded-xl bg-red-50 border border-red-200 font-ui text-sm text-red-600">
                        <?php echo e(session('contact_error')); ?>

                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <form class="space-y-5" action="<?php echo e(route('contact.send')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
            ...
            <div class="reveal">
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:<?php echo e($contactEmail); ?>" class="font-body text-secondary hover:text-onion transition-colors"><?php echo e($contactEmail); ?></a>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-body text-secondary"><?php echo e($contactAddress); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-body text-secondary"><?php echo e($responseTime); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-10 pt-8 border-t border-silver">
                    ...
                    <div class="flex gap-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $siteSocials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e($url); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl bg-pearl hover:bg-onion/10 flex items-center justify-center transition-colors group" title="<?php echo e(ucfirst($name)); ?>">
                                <span class="font-ui text-xs font-bold text-muted group-hover:text-onion transition-colors"><?php echo e(strtoupper(substr($name, 0, 2))); ?></span>
                            </a>
                ...
                <div class="mt-10 p-6 rounded-2xl bg-gradient-to-br from-onion/5 to-sean/5 border border-onion/10">
                    ...
                    <a href="mailto:<?php echo e($partnershipEmail); ?>" class="font-ui text-sm font-semibold text-onion hover:text-onion-dark transition-colors">
                        <?php echo e($partnershipEmail); ?> →
                    </a>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\WebWorka\codeworkflow\blossom\resources\views/pages/contact/index.blade.php ENDPATH**/ ?>