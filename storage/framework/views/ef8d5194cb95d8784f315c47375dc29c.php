        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
            ...
            <div class="lg:col-span-2">
                <a href="<?php echo e(route('home')); ?>" class="inline-block mb-6">
                    <img src="<?php echo e(asset('assets/blossom-logo.png')); ?>" alt="BLOSSOM Logo" class="h-12 w-auto mb-2">
                    <div class="font-ui text-xs tracking-[0.3em] uppercase text-ash mt-1"><?php echo e(setting('site.site.tagline', "Plateau's Prestige Magazine")); ?></div>
                </a>
                ...
                <div class="flex items-center gap-2 max-w-sm">
                    ...
                    <a href="<?php echo e(route('newsletter')); ?>" class="px-5 py-2.5 rounded-lg bg-orange text-white text-sm font-semibold font-ui hover:bg-orange-600 transition-all duration-300 whitespace-nowrap">
                        Join
                    </a>
                </div>
                ...
                <div class="font-ui text-xs text-white/40 mt-4 space-y-1 max-w-sm">
                    <p><a href="mailto:<?php echo e($contactEmail); ?>" class="hover:text-orange transition-colors"><?php echo e($contactEmail); ?></a></p>
                ...
                <div class="flex items-center gap-3 mt-6">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $socials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($social['url']); ?>" target="_blank" rel="noopener noreferrer" class="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-orange hover:border-orange/30 hover:bg-orange/5 transition-all duration-300" aria-label="<?php echo e($social['name']); ?>">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['Articles' => 'articles.index', 'Events' => 'events.index', 'Listings' => 'listings.index', 'Community' => 'community.index', 'Categories' => 'articles.index']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route($route)); ?>" class="font-ui text-sm text-white/50 hover:text-orange transition-colors duration-300"><?php echo e($label); ?></a>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['About Us' => 'about', 'Contact' => 'contact', 'Advertise' => 'advertise', 'Careers' => 'careers', 'Press Kit' => 'press-kit']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route($route)); ?>" class="font-ui text-sm text-white/50 hover:text-orange transition-colors duration-300"><?php echo e($label); ?></a>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['Privacy Policy' => 'privacy', 'Terms of Service' => 'terms', 'Cookie Policy' => 'cookies', 'Accessibility' => 'accessibility']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route($route)); ?>" class="font-ui text-sm text-white/50 hover:text-orange transition-colors duration-300"><?php echo e($label); ?></a>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="border-t border-white/5">
        <div class="max-w-[1440px] mx-auto px-6 lg:px-12 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="font-ui text-xs text-white/30">
                <?php echo setting('site.site.copyright_text', '© ' . date('Y') . ' ' . setting('site.site.company_name', 'Emerald Colours Nigeria Limited') . '. All rights reserved.'); ?>
...
<?php /**PATH C:\WebWorka\codeworkflow\blossom\resources\views/layouts/components/footer.blade.php ENDPATH**/ ?>